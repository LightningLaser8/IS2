...
{
    internal class Keyword(string id, Action<string[], Expression[], IslProgram> action, int argAmount, string[] allowedLabels)
    {
        ...
        /// </summary>
        public Action<string[], Expression[], IslProgram> Action { get; set; } = action;
        public int ArgumentCount = argAmount;

        public static readonly Keyword Nothing = new("", (labels, exprs, prog) => { }, 0, []);
    }
}
